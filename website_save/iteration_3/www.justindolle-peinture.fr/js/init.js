...
const swiper = new Swiper('.swiper-container', {
 ...
 // Submit form
 var myRedirectionUrl = window.location.href
 myRedirectionUrl = myRedirectionUrl.replace('contact', 'thank-you')

// Submit form with formspree
 $('#contact-form-page').submit(function(e){
 	e.preventDefault();
 	$.ajax({
 		url: "https://formspree.io/f/mjvjrjya",
 		method: "POST",
 		dataType: "json",
 		data:$('#contact-form-page').serialize(),
 		success: function(){
